...
describe('PLAYER METHODS', function() {
  describe('validateLocation', function() {
    ...
    it('should confirm valid for unoccupied locations in a range', function() {
      var location = [0,0];
    ...
    it('should confirm INvalid for occupied locations in a range', function() {
      var location = [9,9];
      var actual = validateLocation(player, location);
...
describe('RANDOM METHODS', function() {
